    ...
    <div class="list-pertanyaan">
        <div class="button-group">
            <button class="p btn-blue btn-modal-trigger" id="btn-tambah-pertanyaan" data-modal="#modal-tambah-pertanyaan"
                data-link="{{ route('f.form.pertanyaan.create', $data->token) }}">Tambah
                Pertayaan</button>
            <button class="p btn-red">Kunci Seluruh Pertanyaan</button>
                    ...
                    <tr>
                        ...
                        <td class="aksi">
                            <a href="#" class="edit btn-modal-trigger" data-modal="#modal-tambah-pertanyaan"
                                ...
                                data-link="{{ route('f.form.pertanyaan.update', [$data->token, $p->id]) }}">Edit</a>
                            <a href="#" class="delete btn-delete-pertanyaan">Delete</a>
                            <form action="{{ route('f.form.pertanyaan.destroy', [$data->token, $p->id]) }}" class="hide"
                                method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
    ...
    {{-- <div class="table-jawaban">
        <div class="button-group">
            <div class="input-group">
                ...
                <select name="" id="filter-by" class="form-control">
            ...
            <div class="input-group">
                <label for="value-by">Value Filter</label>
                <input type="text" class="form-control" placeholder="value">
                <select name="" id="filter-by" class="form-control hide">
        ...
        <div class="jawaban-row">index1</div>
        <div class="jawaban-row">index2</div>
        <div class="jawaban-row">index3</div>
        <div class="jawaban-row">index4</div>
        <div class="jawaban-row">index5</div>
        <div class="jawaban-row">index6</div>
        <div class="jawaban-row">index7</div>
        <div class="jawaban-row">index8</div>
        <div class="jawaban-row">index9</div>
        <div class="jawaban-row">index10</div>
        <div class="jawaban-row">index11</div>
        <div class="jawaban-row">index12</div>
        <div class="jawaban-row">index13</div>
        <div class="jawaban-row">index14</div>
        <div class="jawaban-row">index15</div>
        <div class="jawaban-row">index16</div>
        <div class="jawaban-row">index17</div>
        <div class="jawaban-row">index18</div>
        <div class="jawaban-row">index19</div>
        <div class="jawaban-row">index20</div>
        <div class="jawaban-row">index21</div>
        <div class="jawaban-row">index22</div>
        <div class="jawaban-row">index23</div>
        <div class="jawaban-row">index24</div>
        <div class="jawaban-row">index25</div>
        <div class="jawaban-row">index26</div>
        <div class="jawaban-row">index27</div>
        <div class="jawaban-row">index28</div>
        <div class="jawaban-row">index29</div>
        <div class="jawaban-row">index30</div>
        <div class="jawaban-row">index31</div>
        <div class="jawaban-row">index32</div>
        <div class="jawaban-row">index33</div>
        <div class="jawaban-row">index34</div>
        <div class="jawaban-row">index35</div>
        <div class="jawaban-row">index36</div>
        <div class="jawaban-row">index37</div>
        <div class="jawaban-row">index38</div>
        <div class="jawaban-row">index39</div>
        <div class="jawaban-row">index40</div>
        <div class="jawaban-row">index41</div>
        <div class="jawaban-row">index42</div>
        <div class="jawaban-row">index43</div>
        <div class="jawaban-row">index44</div>
        <div class="jawaban-row">index45</div>
        <div class="jawaban-row">
            <span>index46</span>
            <span class="p"><strong>Nama : </strong>Daffa Yr</span>
            <span class="p"><strong>Rumah : </strong>Solo</span>
        </div>
...
<div class="modal hide" id="modal-identity">
    <div class="modal-box">
        ...
        <div class="modal-body p">
            <form action="{{ route('f.form.update', $data->token) }}" method="POST">
                @csrf
                @method('PUT')
...
<div class="modal hide" id="modal-shortlink">
    <div class="modal-box">
        ...
        <hr>
        <div class="modal-body p">
            <form action="{{ route('f.form.bitly', $data->token) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">
...
<div class="modal hide" id="modal-tambah-pertanyaan">
    <div class="modal-box">
        ...
        <hr>
        <div class="modal-body p">
            <form action="{{ route('f.form.pertanyaan.create', $data->token) }}" method="POST">
                @csrf
...
<div class="modal hide" id="modal-urutkan-pertanyaan">
    <div class="modal-box">
        ...
        <hr>
        <div class="modal-body">
            <form action="{{ route('f.form.pertanyaan.sort', $data->token) }}" method="post">
                @csrf
                <div class="form-group">
...
<div class="modal hide" id="modal-delete-form">
    <div class="modal-box">
        ...
        <form action="{{ route('f.form.delete', $data->token) }}" class="hide" method="POST">
            @csrf
            @method('DELETE')
        </form>
        <hr>
