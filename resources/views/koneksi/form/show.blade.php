...
@section('content')
    ...
    <div class="form-show__content">
        <div class="form-show__content-body form-show__content-body--tampilan active">
            <div class="form-show__desc">
                ...
                <p class="form-show__value form-show__value--token grey">{{ $data->token }}</p>
                            ...
                            <td>
                                <span class="form-show__aksi-pertanyaan">
                                    ...
                                    <img src="{{ url('assets/img/delete.svg') }}" class="form-show__delete-pertanyaan"
                                        ...
                                        data-link="{{ route('f.form.pertanyaan.destroy', [$data->token, $p->id]) }}">
                                </span>
                            </td>
                        </tr>
                    @endforeach
    ...
    <div class="form-show__edit-dialog dialog" id="editDialog">
        <div class="form-show__edit-dialog-content">
            <form action="{{ route('f.form.update', $data->token) }}" method="POST"
                class="dialog__card form-show__edit-form">
                @csrf
                @method('PUT')
    ...
    <form action="{{ route('f.form.delete', $data->token) }}" method="POST"
    ...
    <form action="{{ route('f.form.pertanyaan.destroy', [$data->token, $p->id]) }}" method="POST"
        class="form-show__delete-dialog dialog dialog__card" id="deletePertanyaanDialog">
        @csrf
        @method('DELETE')
        ...
        <div class="form-show__edit-dialog-content">
            <form action="{{ route('f.form.pertanyaan.sort', $data->token) }}" method="post"
                ...
                <div class="form__group">
                    ...
                    <select name="pertanyaan" id="sort-pertanyaan" class="form__control form__harus-diisi"
                ...
                <div class="form__group">
                    ...
                    <select name="number" id="sort-urutan" class="form__control form__harus-diisi"
                        data-error="#sort-urutan-error">
                        <option value="" disabled selected>pilih</option>
                        @foreach ($data->pertanyaan as $p)
